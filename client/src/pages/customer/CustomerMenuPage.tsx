...
import { ShoppingCart, Plus, Search, Filter, Truck, Clock, Star } from "lucide-react";
  ...
  const menuItems = [
    {
      id: "1",
      name: "Caesar Salad",
      description: "Fresh romaine lettuce, parmesan cheese, croutons with house-made dressing",
      price: 12.99,
      category: "Appetizers",
      image: "🥗",
      rating: 4.5,
      ...
      <div className="space-y-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">Discover our delicious offerings - Available for dine-in, takeaway & delivery</p>
          </div>
          <div className="flex items-center gap-4">
            <div className="bg-green-50 px-4 py-2 rounded-lg">
              <p className="text-sm text-green-800">🚚 Free delivery over $30</p>
            </div>
