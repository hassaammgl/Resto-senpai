...
import { Minus, Plus, Trash2, MapPin, Clock, CreditCard, Truck, Store, Utensils } from "lucide-react";
              ...
              <CardContent>
                <div className="grid grid-cols-3 gap-4">
                  ...
                  >
                    ...
                    <span>Dine In</span>
                    <span className="text-xs text-gray-500">Table service</span>
                  </Button>
                </div>
              </CardContent>
            </Card>
                ...
                {user?.loyaltyPoints && (
                  <div className="bg-green-50 p-3 rounded-lg">
                    ...
                    <p className="text-xs text-green-600">
                      You'll earn {Math.floor(getGrandTotal())} points from this order
                    </p>
                  </div>
                )}
              </CardContent>
                ...
                <div className="flex items-center gap-3 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {orderType === 'delivery' && '30-45 minutes'}
                      {orderType === 'takeaway' && '15-20 minutes'}
                      {orderType === 'dine-in' && 'Immediate seating'}
                    </p>
                  </div>
                </div>
              </CardContent>
