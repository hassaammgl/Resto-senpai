        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input id="email" defaultValue="info@goldenfork.com" />
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <Label htmlFor="table-requests">Table Requests</Label>
                  <p className="text-sm text-gray-600">Notify for table service requests</p>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <Label htmlFor="weekend-hours">Different Weekend Hours</Label>
                  <p className="text-sm text-gray-600">Use different hours for weekends</p>
                </div>
                <Switch id="weekend-hours" />
              </div>
              <Button className="bg-amber-600 hover:bg-amber-700">Update Hours</Button>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Automatically print new orders</p>
                </div>
