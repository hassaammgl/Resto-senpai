...
import { Plus, Edit, Trash2, Percent, Gift, Calendar, Users, TrendingUp } from "lucide-react";
...
const Promotions = () => {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      case "free_delivery": return <TrendingUp className="h-4 w-4" />;
      case "bogo": return <Users className="h-4 w-4" />;
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-lg font-bold">Student Discount</div>
              <div className="text-sm text-gray-600">234 uses</div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Input id="promo-title" placeholder="e.g., Weekend Special" />
              </div>
              <div>
              ...
              <div>
                ...
                <Input id="promo-value" placeholder="e.g., 20" type="number" />
              </div>
            </div>
            <div className="mt-4">
              <Label htmlFor="promo-description">Description</Label>
              <Textarea id="promo-description" placeholder="Describe your promotion..." />
            </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    ...
                    {promo.type === "bogo" && `Buy 2 Get ${promo.value} Free`}
                  </span>
                </div>
                ...
                {promo.maxUsage && (
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${(promo.usageCount / promo.maxUsage) * 100}%`
                      }}
                    ></div>
                  </div>
                )}
