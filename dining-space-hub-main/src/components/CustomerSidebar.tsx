...
import { Home, Menu, ClipboardList, User, ChefHat, ShoppingCart } from "lucide-react";
...
const CustomerSidebar = () => {
  ...
  const menuItems = [
    ...
    { icon: ShoppingCart, label: "Cart", path: "/customer/cart", badge: cartItemCount > 0 ? cartItemCount : undefined },
